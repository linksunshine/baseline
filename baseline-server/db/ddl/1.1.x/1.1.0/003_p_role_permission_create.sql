...
CREATE TABLE `p_role_permission` (
  `p_role_permission_id` varchar(40) NOT NULL COMMENT '主键',
  `p_role_id` varchar(40) NOT NULL DEFAULT '0' COMMENT '外键角色id',
  `p_permission_id` varchar(40) NOT NULL DEFAULT '0' COMMENT '外键角色id',
  ...
  PRIMARY KEY (`p_role_permission_id`)
